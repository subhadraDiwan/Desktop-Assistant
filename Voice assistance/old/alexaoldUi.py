...
# Form implementation generated from reading ui file 'alexa1Ui.ui'
#
...
class Ui_AlexaUi(object):
    def setupUi(self, AlexaUi):
        ...
        self.pushButton.setGeometry(QtCore.QRect(260, 610, 51, 71))
        self.pushButton.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pushButton.setMouseTracking(False)
        self.pushButton.setTabletTracking(False)
        self.pushButton.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../Downloads/download-removebg-preview.gif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
